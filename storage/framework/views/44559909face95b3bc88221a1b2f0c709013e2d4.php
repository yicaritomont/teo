        ...
        $('.dataTable').DataTable().on( 'xhr', function () {
            ...
            $.each(tableDataAjax.data, function(key, value){
                ...
                markers[id].addListener('click', function(event){
                    infowindow.setContent( '<b><?php echo app('translator')->getFromJson("words.Name"); ?>: </b>'+value.name+'<br><b><?php echo app('translator')->choice("words.Client", 1); ?>: </b>'+value.client.user.name );
