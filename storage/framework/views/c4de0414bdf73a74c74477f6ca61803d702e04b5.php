...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-md-offset-3">
            <a href="<?php echo e(route('users.index')); ?>" class="btn btn-default btn-sm"> <i class="fa fa-arrow-left"></i> <?php echo app('translator')->getFromJson('words.Back'); ?></a>
            <div class="panel panel-default">
                <div class="panel-header-form">
                    <h3 class="panel-titles"><?php echo app('translator')->getFromJson('words.Edit'); ?> <?php echo e($user-> name); ?></h3>                    
                </div>
                <div class="panel-body black-letter">
                    <?php echo Form::model($user, ['method' => 'PUT', 'route' => ['users.update',  $user->id ],'enctype' => "multipart/form-data" ]); ?>
