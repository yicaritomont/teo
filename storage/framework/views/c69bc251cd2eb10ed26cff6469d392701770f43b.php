    ...
    <script>  
        ...
        $(document).ready(function() {
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_menus', 'delete_menus')): ?>
                ...
                dataTableObject.ajax = {url: "<?php echo e(route('datatable', ['model' => 'Menu', 'whereHas' => 'none', 'entity' => 'menus', 'identificador' => 'id', 'relations' => 'menu'])); ?>"};
            ...
            <?php else: ?>
                dataTableObject.ajax = {url: "<?php echo e(route('datatable', ['model' => 'Menu', 'whereHas' => 'none', 'relations' => 'menu'])); ?>"};
