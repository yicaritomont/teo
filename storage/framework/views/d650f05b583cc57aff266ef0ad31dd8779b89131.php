...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_professions','delete_professions')): ?>
                dataTableObject.ajax = {url: "<?php echo e(route('datatable', ['model' => 'Profession', 'whereHas' => 'none', 'entity' => 'professions', 'identificador' => 'id', 'relations' => 'none'])); ?>"};
            ...
            <?php else: ?>
                dataTableObject.ajax = {url: "<?php echo e(route('datatable', ['model' => 'Profession', 'whereHas' => 'none'])); ?>"};
